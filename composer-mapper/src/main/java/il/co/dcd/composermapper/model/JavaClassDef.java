...
public class JavaClassDef {
    ...
    private String parentClass;                                      // FQCN or simple name
    ...
    public static class ReturnCode {
        ...
        public ReturnCode(String code)              { this.code = code; }
        public String      getCode()                { return code; }
        public Set<String> getMeanings()            { return meanings; }
        public void        addMeaning(String m)     { if (m != null && !m.isBlank()) meanings.add(m); }
    }
}
