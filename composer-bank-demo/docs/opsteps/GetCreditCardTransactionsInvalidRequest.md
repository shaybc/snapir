# GetCreditCardTransactionsInvalidRequest

---
entity_type: opStep
entity_id: GetCreditCardTransactionsInvalidRequest
...
## Transitions
- `onOtherDo` -> unresolved `end`

## Raw Attributes
- ErrorCategory: `20`
- ErrorNumber: `400`
- id: `GetCreditCardTransactionsInvalidRequest`
- implClass: `demo.bankcomposer.operations.common.MapErrorByValueAlways`
- onOtherDo: `end`
