# GetStandingOrdersRSFmt

---
entity_type: format
entity_id: GetStandingOrdersRSFmt
...
## Structure
```xml
<CCXML dataName="GetStandingOrdersResponse">
  <CCTcoll append="true" dataName="StandingOrders" times="*" transparentSource="true">
    <CCXML dataName="StandingOrder">
      <CCString dataName="StandingOrderId"/>
      <CCString dataName="BeneficiaryName"/>
      <NumberFormat dataName="Amount" showDecimalsSep="yes" showThousandsSep="no"/>
      <CCString dataName="Frequency"/>
      <CCDate dataName="NextRunDate" fourDigYear="yes" onFailed="current" ordering="ymd" pattern="yyyyMMdd" usePattern="yes" useSep="no"/>
    </CCXML>
  </CCTcoll>
</CCXML>
```
