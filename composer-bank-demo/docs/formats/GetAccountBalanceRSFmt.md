# GetAccountBalanceRSFmt

---
entity_type: format
entity_id: GetAccountBalanceRSFmt
...
## Structure
```xml
<CCXML dataName="GetAccountBalanceResponse">
  <CCString dataName="AccountId"/>
  <NumberFormat dataName="CurrentBalance" showDecimalsSep="yes" showThousandsSep="no"/>
  <NumberFormat dataName="AvailableBalance" showDecimalsSep="yes" showThousandsSep="no"/>
  <CCString dataName="Currency"/>
  <CCDate dataName="AsOfDate" fourDigYear="yes" onFailed="current" ordering="ymd" pattern="yyyyMMdd" usePattern="yes" useSep="no"/>
</CCXML>
```
