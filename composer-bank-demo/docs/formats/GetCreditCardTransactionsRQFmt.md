# GetCreditCardTransactionsRQFmt

---
entity_type: format
entity_id: GetCreditCardTransactionsRQFmt
...
## Structure
```xml
<CCXML dataName="GetCreditCardTransactionsRequest">
  <CCString dataName="CustomerId"/>
  <CCString dataName="CardId"/>
  <CCDate dataName="FromDate" fourDigYear="yes" onFailed="current" ordering="ymd" pattern="yyyyMMdd" usePattern="yes" useSep="no"/>
  <CCDate dataName="ToDate" fourDigYear="yes" onFailed="current" ordering="ymd" pattern="yyyyMMdd" usePattern="yes" useSep="no"/>
</CCXML>
```
