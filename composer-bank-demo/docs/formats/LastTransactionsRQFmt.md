# LastTransactionsRQFmt

---
entity_type: format
entity_id: LastTransactionsRQFmt
...
## Structure
```xml
<CCXML dataName="LastTransactionsRequest">
  <CCString dataName="CustomerId"/>
  <CCString dataName="AccountId"/>
  <NumberFormat dataName="Limit" showDecimalsSep="no" showThousandsSep="no"/>
</CCXML>
```
